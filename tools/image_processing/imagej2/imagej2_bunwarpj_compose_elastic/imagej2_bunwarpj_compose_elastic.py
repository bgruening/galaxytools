...
parser.add_argument( '--source_elastic_transformation', dest='source_elastic_transformation', default=None, help='Direct source transformation matrix' )
parser.add_argument( '--target_elastic_transformation', dest='target_elastic_transformation', default=None, help='Inverse target transformation matrix' )
