...
parser.add_argument( '--raw_transformation1', dest='raw_transformation1', default=None, help='First raw transformation matrix' )
parser.add_argument( '--raw_transformation2', dest='raw_transformation2', default=None, help='Second raw transformation matrix' )
...
raw_transformation1_path = imagej2_base_utils.get_input_image_path( tmp_dir, args.raw_transformation1, 'txt' )
raw_transformation2_path = imagej2_base_utils.get_input_image_path( tmp_dir, args.raw_transformation2, 'txt' )
...
cmd += ' %s' % raw_transformation1_path
cmd += ' %s' % raw_transformation2_path
