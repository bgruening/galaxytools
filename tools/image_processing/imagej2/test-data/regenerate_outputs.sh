...
# docker run --name test_docker -v $PWD:$PWD:rw -w $PWD --cpus 1 --rm --user 1001:1001 quay.io/local/mulled-v2-557813cb01abcc9c2a8cf25415af954884af9f02:385522849f092c1db17139b50238266fc166e5b1-0 bunwarpj -align 'tools/image_processing/imagej2/test-data/dotblot.jpg' 'NULL' 'tools/image_processing/imagej2/test-data/blobs.gif' 'NULL' 0 2 1 0.0 0.0 1.0 10.0 'tools/image_processing/imagej2/test-data/registered_source1_docker1cpu.png' 'tools/image_processing/imagej2/test-data/registered_target1_docker1cpu.png'
# docker run --name test_docker -v $PWD:$PWD:rw -w $PWD --cpus 1 --rm --user 1001:1001 quay.io/local/mulled-v2-557813cb01abcc9c2a8cf25415af954884af9f02:385522849f092c1db17139b50238266fc166e5b1-0 bunwarpj -align 'tools/image_processing/imagej2/test-data/dotblot.jpg' 'NULL' 'tools/image_processing/imagej2/test-data/blobs.gif' 'NULL' 0 2 1 0.0 0.0 1.0 10.0 'tools/image_processing/imagej2/test-data/registered_source1_docker1cpu.png' 'tools/image_processing/imagej2/test-data/registered_target1_docker1cpu.png' '-save_transformation'
# mv 'tools/image_processing/imagej2/test-data/registered_source1_docker1cpu_transf.txt' 'tools/image_processing/imagej2/test-data/source_elastic_transformation_out_full_docker1cpu.txt'
# mv 'tools/image_processing/imagej2/test-data/registered_target1_docker1cpu_transf.txt' 'tools/image_processing/imagej2/test-data/target_elastic_transformation_out_full_docker1cpu.txt' 
# docker run --name test_docker -v $PWD:$PWD:rw -w $PWD --cpus 1 --rm --user 1001:1001 quay.io/local/mulled-v2-557813cb01abcc9c2a8cf25415af954884af9f02:385522849f092c1db17139b50238266fc166e5b1-0 bunwarpj -align 'tools/image_processing/imagej2/test-data/dotblot.jpg' 'tools/image_processing/imagej2/test-data/mask_white.png' 'tools/image_processing/imagej2/test-data/blobs.gif' 'tools/image_processing/imagej2/test-data/mask_ramp.gif' 0 2 1 0.0 0.0 1.0 10.0 'tools/image_processing/imagej2/test-data/registered_source2_docker1cpu.png' 'tools/image_processing/imagej2/test-data/registered_target2_docker1cpu.png'
