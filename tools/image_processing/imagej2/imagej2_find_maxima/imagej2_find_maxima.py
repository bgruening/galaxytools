...
parser.add_argument( '--scale_when_converting', dest='scale_when_converting', default='no', help='Scale when converting RGB image' )
parser.add_argument( '--weighted_rgb_conversions', dest='weighted_rgb_conversions', default='no', help='Weighted RGB conversions for RGB image' )
