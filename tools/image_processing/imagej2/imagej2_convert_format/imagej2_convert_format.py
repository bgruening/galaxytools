...
if __name__=="__main__":
    ...
    max_heap_size = imagej2_utils.get_max_heap_size_value( args.max_heap_size_type, args.max_heap_size )
    ...
    try:
        ...
        in_image_path = imagej2_utils.get_input_image_path( tmp_dir, args.in_fname, args.input_datatype )
        # Load the input image.
        image, scale = imagej2_utils.load_image( in_image_path, rescale=False, wants_max_intensity=True )
        # Write the output image.
        out_image_path = imagej2_utils.get_temporary_image_path( tmp_dir, args.output_datatype )
