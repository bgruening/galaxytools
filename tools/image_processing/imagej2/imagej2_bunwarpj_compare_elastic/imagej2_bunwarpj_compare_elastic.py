...
parser.add_argument( '--source_transformation', dest='source_transformation', default=None, help='Direct source transformation matrix' )
parser.add_argument( '--target_transformation', dest='target_transformation', default=None, help='Inverse target transformation matrix' )
...
# Target image : ~/tmpYOkRxE.jpg
# Source image : ~/tmpVVtDiE.gif
# Target Transformation file : ~/tmpi5338f.txt
# Source Transformation file : ~/tmplVWe3l.txt
