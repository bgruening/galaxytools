...
def consisting_of_isoprens(mol):
    ...
    for non_overlapping_match_id_set in g.sets:
        ...
        """
        assume you remaining_atom_ids are all non_carbon
...
def create_file_handles(key_name, is_dir):
    ...
    if is_dir:
        ...
        file_handles = {
            ...
            "potential_terpenoids": open(
                "./%s/potential_terpenoids/potential_terpenoids.txt" % (dir_prefix), "a"
            ),
        }
    else:
        file_handles = {
...
def args_wrapper():
    ...
    parser = argparse.ArgumentParser(
        description="Filters a compound library and returns terpens.", epilog="TODO!"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Specify the key name of the SDF metadata, \
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="The structure must be consisting of non overlapping isopren units. default: True",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Creates images for each found terpen. default: False",
    )
    parser.add_argument(
        "--inchi",
        action="store_true",
        default=False,
        help="Creates InChI's for each found terpen. default: False",
    )
    parser.add_argument(
        "--mol",
        action="store_true",
        default=False,
        help="Creates SDF-Files for each found terpen. default: False",
    )
