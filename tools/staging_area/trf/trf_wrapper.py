...
def __main__():
    ...
    parser.add_option(
        ...
        dest="flanking",
        action="store_true",
        help="Flanking sequence",
    )
    parser.add_option(
        "-m", "--masked", dest="masked", action="store_true", help="Masked sequence"
    )
    parser.add_option(
        "-r",
        "--redundancy",
        dest="redundancy",
        action="store_true",
        help="No redundance elimination",
    )
    parser.add_option(
        "-o",
        "--datoutput",
    ...
    parser.add_option(
        "-t", "--report", dest="report", action="store", help="Report file name"
    )
    parser.add_option(
        "-i", "--indices", dest="indices", action="store", help="Indices file name"
    )
