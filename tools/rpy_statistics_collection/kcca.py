...
if ncomps < 1:
    print(
        "You chose to return '0' canonical components. Please try rerunning the tool with number of components = 1 or more."
    )
    sys.exit()
elems = []
